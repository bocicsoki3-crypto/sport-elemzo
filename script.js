...
sessionStorage.setItem('openingOdds', JSON.stringify(data.odds || {}));
        ...
        addRosterToggleListeners();
// === ÚJ (6 FŐS BIZOTTSÁG) === Hozzáadjuk az új eseményfigyelőt
...
function openManualAnalysisModal() {
    let content = `
        ...
        <div class="control-group" style="margin-top: 1rem;">
            <label 
for="manual-away">Vendég csapat</label>
        ...
        <div class="control-group" style="margin-top: 1rem;">
            <label 
for="manual-kickoff">Kezdési idő (UTC Dátum és Idő)</label>
...
// Megakadályozza a <details> elem automatikus nyitását/zárását
...
if (placeholder) {
        ...
        details.open = true;
// Kinyitjuk, hogy a user lássa a töltést
...
container.innerHTML = `<p class="muted" style="color:var(--danger); font-size: 0.8rem;">A keretek lekérése sikertelen: ${e.message}</p>`;
            details.open = true;
// Nyitva tartjuk, hogy a hiba látható legyen
        }
    } else {
        details.open = false;
// Ha már nyitva volt, csukja be
    }
}
...
// Beinjektáljuk a DOM-ba
    } else {
        return finalHtml;
// Visszaadjuk stringként (az elemzési modal számára)
    }
}
        ...
        <details class="analysis-accordion-item" open>
            <summary class="analysis-accordion-header">
                <span class="section-title">
                    <svg class="section-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" 
rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>
